...
$(document).ready(function(){
	...
	mezzi.forEach(function(m){
		strutture.forEach(function(s){
			...
			$('#pm'+i).click(function(){
				var fineTappa = prompt("Inserire la data in cui si vuole terminare la tappa:", "yyyy-MM-dd");
			    if (fineTappa != null && fineTappa != "yyyy-MM-dd") {
			    	...
			    	.done(function(tappe){
			    			...
			    			sessionStorage.setItem('fineTappa', fineTappa);
